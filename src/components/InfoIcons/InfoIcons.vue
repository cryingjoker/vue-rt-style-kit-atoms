...
import './InfoIcons.styl'

import infoIcons from '../../info-icons.json'
...
const infoIconsData = JSON.parse(de(infoIcons.data))
export default {
  name: "RtInfoIcons",
  props: {
    name: {
  ...
  methods: {
    setOptions() {
      if (this.localName in infoIconsData) {
        this.optios = infoIconsData[this.localName]
